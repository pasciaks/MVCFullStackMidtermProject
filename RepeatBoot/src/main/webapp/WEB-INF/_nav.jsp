	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav">
				...
				<li><a class="nav-link" href="list_experience.do">Flight
						Logs</a></li>
				<li><a class="nav-link" href="evaluate_experience.do">Evaluate
						Flight Logs</a></li>
				<li><a class="nav-link" href="clerk_one">clerk task 1</a></li>
				<li><a class="nav-link" href="clerk_one">clerk task 2</a></li>
				<li><a class="nav-link" href="clerk_one">clerk task 3</a></li>
			</div>
		</div>
	</div>
</nav>